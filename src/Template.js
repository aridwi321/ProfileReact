        ...
        <div className="container-wrap">
          ...
          <aside id="colorlib-aside" role="complementary" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url(style/images/about.jpg)'}} />
              <h1 id="colorlib-logo"><a href="index.html">Ari Dwi Prasetia</a></h1>
              <span className="position"><a href="#">Software Engineering</a> <br/>in Indonesia</span>
            </div>
          ...
          <div id="colorlib-main">
            <section id="colorlib-hero" className="js-fullheight" data-section="home">
              <div className="flexslider js-fullheight">
                <ul className="slides">
                  <li style={{backgroundImage: 'url(style/images/img_bg_1.jpg)'}}>
                      ...
                      <div className="row">
                        <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                          <div className="slider-text-inner js-fullheight">
                            <div className="desc">
                              <h1 style={{color: 'white'}}>Hi! <br />I'm Ari</h1>
                              <h2 style={{color: 'white'}}></h2>
                              <p style={{color: 'white'}}><a className="btn btn-primary btn-learn" style={{color: 'white'}}>Download CV <i className="icon-download4" /></a></p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <li style={{backgroundImage: 'url(style/images/img_bg_2.jpg)'}}>
                    <div className="overlay" />
                    <div className="container-fluid">
                      <div className="row">
                        <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                          <div className="slider-text-inner">
                            <div className="desc">
                              <h1 style={{color: 'white'}}>I am <br />a Software Engineer</h1>
                              <h2 style={{color: 'white'}}></h2>
                              <p style={{color: 'white'}}><a className="btn btn-primary btn-learn"  style={{color: 'white'}}>View Portfolio <i className="icon-briefcase3" /></a></p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                      <div className="col-md-12">
                        <div className="about-desc">
                          ...
                          <p><strong>Hi I'm Ari Dwi Prasetia</strong> On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word "and" and the Little Blind Text should turn around and return to its own, safe country.</p>
            ...
            <div id="colorlib-counter" className="colorlib-counters" style={{backgroundImage: 'url(style/images/cover_bg_1.jpg)'}} data-stellar-background-ratio="0.5">
              <div className="overlay" />
              <div className="colorlib-narrow-content">
                <div className="row">
                </div>
                        ...
                        <div className="panel panel-default">
                          ...
                          <div id="collapseFour" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                            <div className="panel-body">
                              <p>I will graduate from UGM in 2020, I have a good moivaion for progress and growth, and I am eager o learn and work as team  whhich is involed in your company succesfull businnes. Furthermore, I can work under pressure and cope well wih high stres siuation</p>	
                            </div>
                          </div>
                        </div>
                        <div className="panel panel-default">
                          <div className="panel-heading" role="tab" id="headingFive">
                            <h4 className="panel-title">
                              <a className="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">High School 2 Cirebon
                              </a>
                            </h4>
                          </div>
                          <div id="collapseFive" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                            <div className="panel-body">
                              <p>I am graduate from high school 2 cirebon  in 2020, I have a good moivaion for progress and growth, and I am eager o learn and work as team  whhich is involed in your company succesfull businnes. Furthermore, I can work under pressure and cope well wih high stres situation</p>	
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <section className="colorlib-work" data-section="work">
              <div className="colorlib-narrow-content">
                ...
                <div className="row">
                  <div className="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                    <div className="project" style={{backgroundImage: 'url(style/images/img-1.jpg)'}}>
                      <div className="desc">
                        <div className="con">
                  ...
                  <div className="col-md-6 animate-box" data-animate-effect="fadeInRight">
                    <div className="project" style={{backgroundImage: 'url(style/images/img-2.jpg)'}}>
                      <div className="desc">
                        <div className="con">
                  ...
                  <div className="col-md-6 animate-box" data-animate-effect="fadeInTop">
                    <div className="project" style={{backgroundImage: 'url(style/images/img-3.jpg)'}}>
                      <div className="desc">
                        <div className="con">
                  ...
                  <div className="col-md-6 animate-box" data-animate-effect="fadeInBottom">
                    <div className="project" style={{backgroundImage: 'url(style/images/img-4.jpg)'}}>
                      <div className="desc">
                        <div className="con">
                  ...
                  <div className="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                    <div className="project" style={{backgroundImage: 'url(style/images/img-5.jpg)'}}>
                      <div className="desc">
                        <div className="con">
                  ...
                  <div className="col-md-6 animate-box" data-animate-effect="fadeInRight">
                    <div className="project" style={{backgroundImage: 'url(style/images/img-6.jpg)'}}>
                      <div className="desc">
                        <div className="con">
                ...
                <div className="row">
                  <div className="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
                    <div className="blog-entry">
                      <a href="blog.html" className="blog-img"><img src="style/images/blog-1.jpg" className="img-responsive" alt="HTML5 Bootstrap Template by colorlib.com" /></a>
                      <div className="desc">
                  ...
                  <div className="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInRight">
                    <div className="blog-entry">
                      <a href="blog.html" className="blog-img"><img src="style/images/blog-2.jpg" className="img-responsive" alt="HTML5 Bootstrap Template by colorlib.com" /></a>
                      <div className="desc">
                        <span><small>April 14, 2018 </small> | <small> Web Design </small> | <small> <i className="icon-bubble3" /> 4</small></span>
                  ...
                  <div className="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
                    <div className="blog-entry">
                      <a href="blog.html" className="blog-img"><img src="style/images/blog-3.jpg" className="img-responsive" alt="HTML5 Bootstrap Template by colorlib.com" /></a>
                      <div className="desc">
